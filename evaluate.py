...
# data
from KIE.data.generate import CustomDataset, TestBatchCollator
from KIE.data.preprocessing import create_dataloader
from KIE.data.postprocessing import convert_predictions_to_dict
# model
...
class Prediction:
    def __init__(self):
        ...
        self.path_to_submit = osp.join(output_dir, "submit2")
        ...
        test_dataset = CustomDataset(new_dir=dict(configs.DATASET.TEST))
